package io.keiji.realmsample2.sqlite.entity;
...
public class Character {
    ...
    public static Character read(Cursor cursor) {
        ...
        character.setAge(cursor.getInt(cursor.getColumnIndex("age")));
        character.setMegane(cursor.getInt(cursor.getColumnIndex("megane")) == 1);
        return character;
    }
